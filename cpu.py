...
class Raw_CPU:
    def __init__(self):
        ...
        self.PC = 0
        self.reg = [0] * 16 # Use list for indexed access, easier than dict for hardware sim
...
class CPUSimulator(Raw_CPU):
    def __init__(self, mem):
        ...
        # Internal pipeline registers (state between stages)
        self.icode = 0
        self.ifun = 0
        self.rA = 15
        self.rB = 15
    ...
    def fetch(self):
        ...
        need_reg = self.icode in [2, 3, 4, 5, 6, 10, 11] # cmov, irmov, rmmov, mrmov, op, push, pop
        need_valC = self.icode in [3, 4, 5, 7, 8] # irmov, rmmov, mrmov, jxx, call
